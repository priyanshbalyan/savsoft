...
// environment empty for real and sandbox. for testing (don't forget dot at end of sandbox)
$config['checkout_environment']="sandbox.";
$config['checkout_sid']="";
$config['checkout_SecretWord']="";
$config['checkout_receiver']="";
$config['checkout_currency_prefix']="$";
$config['checkout_currency_sufix']="USD";
// 1 unit of checkout currency = how many unit of base currency
$config['checkout_conversion']="1";
...
$config['paytm_merchant_website']="WEB_STAGING";
$config['paytm_currency_prefix']="Rs";
$config['paytm_currency_sufix']="INR";
// 1 unit of paytm currency = how many unit of base currency
$config['paytm_conversion']="66";
